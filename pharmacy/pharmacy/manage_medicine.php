        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Manage Medicine </h3>
                        ...
                        <tr>
                          ...
                          <td><?php echo $data->add_date;?></td>
                           ...
                           <td>
                            ...
                            <a href="medicine_delete?deletemedicine=<?php echo $data->med_id?>" class="btn btn-danger" onclick="return deletebtn();">Delete</a> 
                          </td>
          ...
          <script>
    function deletebtn(){
      if(confirm("Are you sure delete yes or no")){
        return true;
      }else{
        return false;
      }
