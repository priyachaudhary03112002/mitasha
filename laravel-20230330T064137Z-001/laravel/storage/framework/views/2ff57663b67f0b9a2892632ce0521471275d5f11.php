	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item cta cta-colored"><a href="<?php echo e(url('cart')); ?>" class="nav-link">
				<span class="icon-shopping_cart"></span>(<?php if(!empty($total_cart)): ?>
				<?php echo e($total_cart); ?>

				<?php endif; ?>)</a></li>
				<li class="nav-item cta cta-colored1"><a href="<?php echo e(url('wishlist')); ?>" class="nav-link">
				<span class="icon-heart"></span>(<?php if(!empty($total_wish)): ?>
				<?php echo e($total_wish); ?> 
				<?php endif; ?>)</a></li>
