...
<head>
    ...
    <link href="<?php echo e(url('backend/assets/vendors/bootstrap/dist/css/bootstrap.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(url('backend/assets/vendors/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(url('backend/assets/vendors/themify-icons/css/themify-icons.css')); ?>" rel="stylesheet" />
    <!-- PLUGINS STYLES-->
    <link href="<?php echo e(url('backend/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.css')); ?>" rel="stylesheet" />
    <!-- THEME STYLES-->
    <link href="<?php echo e(url('backend/assets/css/main.min.css')); ?>" rel="stylesheet" />
    <!-- PAGE LEVEL STYLES-->
</head>
<body class="fixed-navbar">
    ...
    <div class="page-wrapper">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    <div>
                        <img src="<?php echo e(url('backend/assets/img/admin-avatar.png')); ?>" width="45px" />
                    </div>
                    <div class="admin-info">
                        <div class="font-strong"></div> <?php echo e(session('name')); ?> <br>
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-table"></i>
                            <span class="nav-label">Welcome <?php echo e(session('name')); ?></span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <li>
        ...
        <!-- END SIDEBAR--><?php /**PATH C:\xampp\htdocs\mitasha\laravel\resources\views/backend/layout/header.blade.php ENDPATH**/ ?>