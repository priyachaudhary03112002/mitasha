	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item cta cta-colored"><a href="{{url('cart')}}" class="nav-link">
				<span class="icon-shopping_cart"></span>(@if(!empty($total_cart))
				{{$total_cart}}
				@endif)</a></li>
				<li class="nav-item cta cta-colored1"><a href="{{url('wishlist')}}" class="nav-link">
				<span class="icon-heart"></span>(@if(!empty($total_wish))
				{{$total_wish}} 
				@endif)</a></li>
