...
<div class="hero-wrap hero-bread" style="background-image: url({{url('frontend/images/back3.jpg')}});">
	...
	<form action="{{url('product_single/'.$product_data->id)}}" method="post" enctype="multipart/form-data">
				@csrf
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">₹{{$d->mainprice}}</span><span class="price-sale">₹{{$d->discprice}}</span></p>
		    					</div>
	    					</div>
