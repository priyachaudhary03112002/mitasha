            ...
            <div class="card-body">
              ...
              <form  action ="#" method="post" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="cate_name" class="form-control" id="cate_name" value="<?php echo $fetch->cate_name?>">
                </div>
                <div class="col-12">
                  <label for="image" class="form-label">Category Image</label>
                  <input type="file"  name="cate_img" class="form-control" id="cate_img">
                  <img src="image/upload/<?php echo $fetch->cate_img?>" style="width:100px;height:100px" alt="">
                </div>
