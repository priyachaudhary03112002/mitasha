      ...
      <div class="container">
        ...
        <div class="col-md-2">
          ...
          <div class="col-md-8 order-md-last d-flex">
            <form action="<?php echo e(url('/login1')); ?>" class="bg-white p-5 contact-form" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mitasha\laravel\resources\views/frontend/login1.blade.php ENDPATH**/ ?>