			 ...
			 foreach($data as $d) 
			 {
			  ?>  
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="<?php echo e(url('product-single/'.$d->id)); ?>" class="img-prod"><img class="img-fluid" src="<?php echo e(url('backend/assets/img/upload/product/'.$d->img)); ?>"  alt="Colorlib Template">
    						...
    						<div class="d-flex">
	     					...
	     					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
									...
									<form action="<?php echo e(url('shop/'.$d->id)); ?>" method="post">
				                  <?php echo csrf_field(); ?>
								 ...
								 <div class="m-auto d-flex">
	    							<a href="<?php echo e(url('cart/'.$d->id)); ?>"><button type="submit"  class="cartbtn"><i class="ion-ios-cart"></i></button></a>&nbsp;
									<a href="<?php echo e(url('wishlist/'.$d->id)); ?>"><button type="submit"  class="cartbtn"><i class="ion-ios-heart"></i></button></a>
			 </div>
<!--                                   
