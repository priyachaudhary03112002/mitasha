...
<head>
    ...
    <link rel="stylesheet" href="{{url('backend/assets/vendor/fonts/material-design-iconic-font/css/materialdesignicons.min.css')}}">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{url('backend/assets/images/img.png')}}" alt="" class="user-avatar-md rounded-circle"></a>
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name">{{session('name')}}</h5>
                        ...
                        <ul class="navbar-nav flex-column">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <!-- <li class="nav-item">
                                          ...
                                          <li class="nav-item">
                                            <a class="nav-link" href="{{url('/other_doctor')}}">view other doctors</a>
                                        </li> 
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/manage_appointment')}}">Manage patients appointment </a>
                                        </li> 
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-7" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/all_doctor')}}">view All doctors</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/book_appointment')}}">book appointment to specific  doctor </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            @if(session()->has('id'))
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-fw fa-file"></i>  Welcome {{session('name')}} </a>
