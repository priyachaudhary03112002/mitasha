            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding">
                        <img src="<?php echo e(url('frontend/assets/images/feature1.png')); ?>" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-md-0">
                        <img src="<?php echo e(url('frontend/assets/images/feature2.png')); ?>" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        <img src="<?php echo e(url('frontend/assets/images/feature3.png')); ?>" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        <img src="<?php echo e(url('frontend/assets/images/feature4.png')); ?>" alt="">
            ...
            <div class="row">
                <div class="col-lg-5 align-self-center">
                    <div class="welcome-img">
                        <img src="<?php echo e(url('frontend/assets/images/welcome.png')); ?>" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                ...
                <div class="col-lg-12">
                    <div class="department-slider owl-carousel">
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="<?php echo e(url('frontend/assets/images/department1.jpg')); ?>" alt="" class="img-fluid">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="<?php echo e(url('frontend/assets/images/department2.jpg')); ?>" alt="" class="img-fluid">
                                <div class="hover-state">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="<?php echo e(url('frontend/assets/images/department3.jpg')); ?>" alt="" class="img-fluid">
                                <div class="hover-state">
                                    <a href="departments.html"><i class="fa fa-stethoscope"></i></a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="single-patient mb-4">
                        <img src="<?php echo e(url('frontend/assets/images/patient1.png')); ?>" alt="">
                        <h3>daren jhonson</h3>
                        <h5>hp specialist</h5>
                    ...
                    <div class="single-patient">
                        <img src="<?php echo e(url('frontend/assets/images/patient2.png')); ?>" alt="">
                        <h3>black heiden</h3>
                        <h5>hp specialist</h5>
                        <p class="pt-3">Elementum libero hac leo integer. Risus hac road parturient feugiat. Litora cursus hendrerit bib elit Tempus inceptos posuere metus.</p>
                    </div>
                ...
                <div class="col-lg-5 offset-lg-1 align-self-center">
                    <div class="appointment-form text-center mt-5 mt-lg-0">
                        ...
                        <form action="#">
                            ...
                            <button type="submit" class="template-btn">appointment now</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
              <?php $__currentLoopData = $fetch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-lg-0">
                        <div class="doctor-img">
                            <img src="<?php echo e(url('backend/assets/img/upload/'.$f->img)); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3><?php echo e($f->name); ?></h3>
                                <h6><?php echo e($f->degree); ?></h6>
                            </div>
                            <div class="doctor-text text-center">
                                ...
                                <div> 
                                    <button type="submit" name="submit"><a href="<?php echo e(url('/doctor')); ?>">View Doctor</a></button>
                                 </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-lg-0">
                        <div class="doctor-img">
                            <img src="<?php echo e(url('frontend/assets/images/doctor2.jpg')); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3>dand mories</h3>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-sm-0">
                        <div class="doctor-img">
                            <img src="<?php echo e(url('frontend/assets/images/doctor3.jpg')); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3>align board</h3>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor">
                        <div class="doctor-img">
                            <img src="<?php echo e(url('frontend/assets/images/doctor4.jpg')); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3>jeson limit</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-news">
                        <div class="news-img">
                            <img src="<?php echo e(url('frontend/assets/images/news1.jpg')); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="news-text">
                            <div class="news-date">
                                22 July 2018
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-news mt-5 mt-md-0">
                        <div class="news-img">
                            <img src="<?php echo e(url('frontend/assets/images/news2.jpg')); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="news-text">
                            <div class="news-date">
                                22 Oct 2018
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-news mt-5 mt-lg-0">
                        <div class="news-img">
                            <img src="<?php echo e(url('frontend/assets/images/news3.jpg')); ?>" alt="" class="img-fluid">
                        </div>
                        <div class="news-text">
                            <div class="news-date">
                                22 Sep 2018
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mitasha\Healthify\resources\views/frontend/index.blade.php ENDPATH**/ ?>