...
<body>
    ...
    <!-- signup form  -->
    <!-- ============================================================== -->
    <form class="splash-container" action="<?php echo e(url('/register_patient')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="card">
            <div class="card-header">
                <h3 class="mb-1"> patients Registrations Form</h3>
            ...
            <div class="card-footer bg-white">
                <p>Already member? <a href="<?php echo e(url('/login_patient')); ?>" class="text-secondary">Login Here.</a></p>
            </div>
        </div>
    </form>
</body>
...
<?php echo $__env->make('backend.layout.main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mitasha\Healthify\resources\views/backend/register_patient.blade.php ENDPATH**/ ?>