...
<!-- ============================================================== -->
    ...
    <!-- signup form  -->
    <!-- ============================================================== -->
    <form class="splash-container" action="<?php echo e(url('/register_doctor')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="card">
            ...
            <div class="card-footer bg-white">
                <p>Already member? <a href="<?php echo e(url('/login_doctor')); ?>" class="text-secondary">Login Here.</a></p>
            </div>
        </div>
    </form>
</body>
...
<?php echo $__env->make('backend.layout.main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mitasha\Healthify\resources\views/backend/register_doctor.blade.php ENDPATH**/ ?>