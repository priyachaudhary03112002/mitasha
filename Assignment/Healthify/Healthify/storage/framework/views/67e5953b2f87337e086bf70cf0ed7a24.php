...
<body>
    ...
    <div class="splash-container">
        ...
        <div class="card-header">
            ...
            <div class="card-body">
                <form action="<?php echo e(url('/login_doctor')); ?>" method="post">
                    <?php echo csrf_field(); ?>
            ...
            <div class="card-footer bg-white p-0  ">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="<?php echo e(url('/register_doctor')); ?>" class="footer-link">Create An Account</a></div>
                <div class="card-footer-item card-footer-item-bordered">
...
<?php echo $__env->make('backend.layout.main1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mitasha\Healthify\resources\views/backend/login_doctor.blade.php ENDPATH**/ ?>